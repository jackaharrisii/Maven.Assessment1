...
public class StringUtils extends BasicStringUtils {
    ...
    public static String reverseFirstWord(String sentence) {
        return reverse(getFirstWord(sentence));   //calling the reverse method from superclass BasicStringUtils on the getFirstWord method above
    }
    ...
    public static String reverseFirstWordThenCamelCase(String sentence) {
        return reverseThenCamelCase(getFirstWord(sentence));    //ditto
    }
